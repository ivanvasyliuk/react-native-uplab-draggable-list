...
const TOUCHABLE_CURSOR_SIZE = 80;
...
export const Wallet = () => {
  ...
  const style = useAnimatedStyle(() => {
    return {
      position: "absolute",
      width: TOUCHABLE_CURSOR_SIZE,
      height: TOUCHABLE_CURSOR_SIZE,
      left: x.value - TOUCHABLE_CURSOR_SIZE / 2,
      top: translateY + y.value - TOUCHABLE_CURSOR_SIZE / 2,
    };
  });
